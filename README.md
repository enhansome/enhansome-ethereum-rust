...
* [libp2p](https://github.com/libp2p/rust-libp2p) ⭐ 5,612 | 🐛 286 | 🌐 Rust | 📅 2026-09-14.
  The Rust implementation of the libp2p networking stack.
* [Lighthouse](https://github.com/sigp/lighthouse) ⭐ 3,471 | 🐛 548 | 🌐 Rust | 📅 2026-09-14.
  Ethereum consensus client.
* [grandine](https://github.com/grandinetech/grandine) ⭐ 277 | 🐛 142 | 🌐 Rust | 📅 2026-09-14.
...
* [Reth](https://github.com/paradigmxyz/reth) ⭐ 5,771 | 🐛 283 | 🌐 Rust | 📅 2026-09-14.
  Ethereum execution client.
* [ethrex](https://github.com/lambdaclass/ethrex) ⭐ 896 | 🐛 1,001 | 🌐 Rust | 📅 2026-09-14.
...
* [evm-inspectors](https://github.com/paradigmxyz/evm-inspectors) ⭐ 256 | 🐛 15 | 🌐 Rust | 📅 2026-09-14.
...
* [alloy](https://github.com/alloy-rs/alloy) ⭐ 1,329 | 🐛 124 | 🌐 Rust | 📅 2026-09-14.
...
* [chains](https://github.com/alloy-rs/chains) ⭐ 109 | 🐛 4 | 🌐 Rust | 📅 2026-09-14.
...
* [Rundler](https://github.com/alchemyplatform/rundler) ⭐ 391 | 🐛 48 | 🌐 Rust | 📅 2026-09-10.
...
* [sp1](https://github.com/succinctlabs/sp1) ⭐ 1,733 | 🐛 135 | 🌐 Rust | 📅 2026-09-14.
  A performant, 100% open-source, contributor-friendly zkVM.
* [noir-lang](https://github.com/noir-lang/noir) ⭐ 1,400 | 🐛 819 | 🌐 Rust | 📅 2026-09-14.
...
* [OpenVM](https://github.com/openvm-org/openvm) ⭐ 392 | 🐛 11 | 🌐 Rust | 📅 2026-09-14.
...
* [Cairo](https://github.com/starkware-libs/cairo) ⭐ 1,905 | 🐛 209 | 🌐 Rust | 📅 2026-09-14.
...
* [Starknet Foundry](https://github.com/foundry-rs/starknet-foundry) ⭐ 393 | 🐛 188 | 🌐 Rust | 📅 2026-09-14.
...
* [Sway](https://github.com/FuelLabs/sway) ⭐ 61,441 | 🐛 949 | 🌐 Rust | 📅 2026-09-07.
  Sway is a language developed for the Fuel blockchain. It is heavily inspired by Rust and aims to bring modern language development and performance to the blockchain ecosystem.
* [fuel-core](https://github.com/FuelLabs/fuel-core) ⭐ 56,847 | 🐛 202 | 🌐 Rust | 📅 2026-09-13.
  Rust full node implementation of the Fuel v2 protocol.
* [fuels-rs](https://github.com/FuelLabs/fuels-rs) ⭐ 43,023 | 🐛 75 | 🌐 Rust | 📅 2026-08-29.
  Rust SDK for Fuel.

### Aztec

* [aztec-nr](https://github.com/AztecProtocol/aztec-nr) ⭐ 150 | 🐛 24 | 🌐 Noir | 📅 2026-09-14.
...
* [Foundry](https://github.com/foundry-rs/foundry) ⭐ 10,599 | 🐛 274 | 🌐 Rust | 📅 2026-09-14.
...
* [solar](https://github.com/paradigmxyz/solar) ⭐ 560 | 🐛 19 | 🌐 Rust | 📅 2026-09-14.
  Blazingly fast, modular and contributor friendly Solidity compiler, written in Rust.

## Smart Contracts

* [Fe](https://github.com/ethereum/fe) ⭐ 1,732 | 🐛 133 | 🌐 Rust | 📅 2026-09-14.
