...
* [libp2p](https://github.com/libp2p/rust-libp2p) ⭐ 5,612 | 🐛 295 | 🌐 Rust | 📅 2026-09-07.
  The Rust implementation of the libp2p networking stack.
* [Lighthouse](https://github.com/sigp/lighthouse) ⭐ 3,467 | 🐛 545 | 🌐 Rust | 📅 2026-09-08.
  Ethereum consensus client.
* [grandine](https://github.com/grandinetech/grandine) ⭐ 277 | 🐛 140 | 🌐 Rust | 📅 2026-09-08.
...
* [Reth](https://github.com/paradigmxyz/reth) ⭐ 5,769 | 🐛 255 | 🌐 Rust | 📅 2026-09-08.
...
* [Revm](https://github.com/bluealloy/revm/) ⭐ 2,229 | 🐛 86 | 🌐 Rust | 📅 2026-09-08.
...
* [pevm](https://github.com/risechain/pevm) ⭐ 356 | 🐛 74 | 🌐 Rust | 📅 2026-08-05.
  Blazingly fast Parallel EVM in Rust.
* [revmc](https://github.com/paradigmxyz/revmc) ⭐ 288 | 🐛 3 | 🌐 Rust | 📅 2026-09-06.
...
* [alloy](https://github.com/alloy-rs/alloy) ⭐ 1,329 | 🐛 138 | 🌐 Rust | 📅 2026-09-08.
...
* [trie](https://github.com/alloy-rs/trie) ⭐ 162 | 🐛 7 | 🌐 Rust | 📅 2026-09-08.
...
* [milhouse](https://github.com/sigp/milhouse) ⭐ 26 | 🐛 22 | 🌐 Rust | 📅 2026-09-08.
...
* [sp1](https://github.com/succinctlabs/sp1) ⭐ 1,733 | 🐛 133 | 🌐 Rust | 📅 2026-09-08.
  A performant, 100% open-source, contributor-friendly zkVM.
* [noir-lang](https://github.com/noir-lang/noir) ⭐ 1,397 | 🐛 792 | 🌐 Rust | 📅 2026-09-08.
...
* [op-succinct](https://github.com/succinctlabs/op-succinct) ⭐ 214 | 🐛 39 | 🌐 Rust | 📅 2026-09-07.
...
* [Cairo](https://github.com/starkware-libs/cairo) ⭐ 1,906 | 🐛 208 | 🌐 Rust | 📅 2026-09-08.
...
* [Sway](https://github.com/FuelLabs/sway) ⭐ 61,453 | 🐛 937 | 🌐 Rust | 📅 2026-09-07.
  Sway is a language developed for the Fuel blockchain. It is heavily inspired by Rust and aims to bring modern language development and performance to the blockchain ecosystem.
* [fuel-core](https://github.com/FuelLabs/fuel-core) ⭐ 56,863 | 🐛 200 | 🌐 Rust | 📅 2026-09-06.
  Rust full node implementation of the Fuel v2 protocol.
* [fuels-rs](https://github.com/FuelLabs/fuels-rs) ⭐ 43,035 | 🐛 73 | 🌐 Rust | 📅 2026-08-29.
  Rust SDK for Fuel.

### Aztec

* [aztec-nr](https://github.com/AztecProtocol/aztec-nr) ⭐ 150 | 🐛 24 | 🌐 Noir | 📅 2026-09-08.
...
* [Foundry](https://github.com/foundry-rs/foundry) ⭐ 10,583 | 🐛 270 | 🌐 Rust | 📅 2026-09-08.
...
* [solar](https://github.com/paradigmxyz/solar) ⭐ 559 | 🐛 12 | 🌐 Rust | 📅 2026-09-08.
